...
#x0_array = np.linspace(0, 10, 100)
#n=0
#new_x0_array = np.zeros(50)
#for n in range(0,50):
#	new_x0_array[n] = x0_array[n]
#
#Pk_array = table[:,1]
#
#
##print(len(new_x0_array))
#print(len(k_array))
#print(Pk_array)

#sys.exit()
#func = interp2d(r_array, new_x0_array, A_array, kind="linear")
#
#curve1 = np.zeros(50)
#curve2 = np.zeros(50)
#curve3 = np.zeros(50)
...
#i=0
#for i in range(0,50):
#	curve1[i] = func(r_array[0],new_x0_array[i])
#	curve2[i] = func(r_array[1],new_x0_array[i])
#	curve3[i] = func(r_array[2],new_x0_array[i])
#	curve4[i] = func(r_array[3],new_x0_array[i])
#	curve5[i] = func(r_array[4],new_x0_array[i])
#	curve6[i] = func(r_array[5],new_x0_array[i])
#
#	i = i + 1
#
#np.savetxt("curve1_-9.dat", np.transpose([new_x0_array, curve1]), fmt="%e", delimiter=" ")
#np.savetxt("curve2_-9.dat", np.transpose([new_x0_array, curve2]), fmt="%e", delimiter=" ")
#np.savetxt("curve3_-9.dat", np.transpose([new_x0_array, curve3]), fmt="%e", delimiter=" ")
#np.savetxt("curve4_-9.dat", np.transpose([new_x0_array, curve4]), fmt="%e", delimiter=" ")
#np.savetxt("curve5_-9.dat", np.transpose([new_x0_array, curve5]), fmt="%e", delimiter=" ")
#np.savetxt("curve6_-9.dat", np.transpose([new_x0_array, curve6]), fmt="%e", delimiter=" ")
#
#"""print(func(0,0))
#print(func(0.00001,1))
#print(func(1.29,1))
#print(func(1,1))
#print(func(1,2))
#print(func(2,2))"""
